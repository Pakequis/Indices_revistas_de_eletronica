# Índices de Revistas de Eletrônica Brasileiras
...
- Colunas organizadas por:
	...
	* Componentes: Códigos dos componentes mais importantes que aparecem em uma montagem de um artigo.
    
	* Data: Mês e ano da publicação.

- As revistas "Eletrônica Popular" e "Antena" seguem a númeração de Volume e edição. Optei por representar no formato v,e. Assim 10,4 significa volume 10, edição 4.
